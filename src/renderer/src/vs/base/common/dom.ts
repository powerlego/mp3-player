...
import * as browser from "@renderer/vs/base/browser/browser";
import { domEvent } from "@renderer/vs/base/browser/event";
import { IKeyboardEvent, StandardKeyboardEvent } from "@renderer/vs/base/browser/keyboardEvent";
import { IMouseEvent, StandardMouseEvent } from "@renderer/vs/base/browser/mouseEvent";
import { TimeoutTimer } from "@renderer/vs/base/common/async";
import { CharCode } from "@renderer/vs/base/common/charCode";
import { Emitter, Event } from "@renderer/vs/base/common/event";
import { Disposable, IDisposable, dispose, toDisposable } from "@renderer/vs/base/common/lifecycle";
import * as platform from "@renderer/vs/base/common/platform";
import { coalesce } from "@renderer/vs/base/common/arrays";
...
export const removeClasses: (node: HTMLElement, ...classNames: string[]) => void =
  _classList.removeClasses.bind(_classList);
export const toggleClass: (node: HTMLElement, className: string, shouldHaveIt?: boolean) => void =
  _classList.toggleClass.bind(_classList);
