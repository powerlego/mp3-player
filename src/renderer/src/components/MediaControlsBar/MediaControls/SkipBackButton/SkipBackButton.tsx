  ...
  return isAudioAvailable
    ? (
      <div className="h-8 aspect-square flex justify-center items-center" onClick={skipBack}>
        <SkipBackwardIcon className="m-0 w-4 h-4 cursor-pointer transition-all duration-300 ease-in-out non-scale-stroke fill-gray-600 hover:fill-gray-550 dark:fill-gray-500 hover:dark:fill-gray-350" />
      </div>
    )
    : (
      <div className="h-8 aspect-square flex justify-center items-center">
        <SkipBackwardIcon className="m-0 w-4 h-4 cursor-pointer fill-gray-450 dark:fill-gray-550" />
      </div>
    );
}
